...
<html lang="ko-KR"> 
    <head>
       ...
       <link rel="stylesheet" type="text/css" href="${ctx}/resources/bootstrap/css/bootstrap.min.css">
        -->
        <!-- Custom UI 
        <link rel="stylesheet" type="text/css" href="${ctx}/resources/css/is_header.css">
        -->        
        <link rel="stylesheet" type="text/css" href="${ctx}/resources/css/is_bundle.css">        
        ...
        <script src="${ctx}/resources/js/RealtimeWebClient.js"></script>
        <script type="text/javascript" src="${ctx}/resources/js/modules/common/mgene.js"></script>
        <script type="text/javascript" src="${ctx}/resources/js/modules/app/tc.js"></script>
...
/*             var contextPath = '${pageContext.request.contextPath}';            
    ...
    <body id="page-docs" class="not-front not-logged-in no-sidebars" data-twttr-rendered="true">

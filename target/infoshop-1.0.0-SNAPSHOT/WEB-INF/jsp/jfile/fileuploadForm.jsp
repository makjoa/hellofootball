...
<%@ taglib prefix="jwork" uri="http://www.ibizsoftware.com/tags/jsp"%>
...
jQuery(document).ready(function() {
    fileUploadObj1= new jwork.fileUpload( "fileUploadObj1", "${ctx}", "null", 
...
<input type="hidden" id="totalFileSize" value="0" />
  ...
  <div id="attach-header" class="attach-header enable-cloud-menu">
    <div id="tx_file_attach_layer">
        ...
        <object id="SWFUpload_4" type="application/x-shockwave-flash" data="${ctx}/resources/swfupload/swfupload/swfupload.swf?preventswfcaching=1370826936903" width="92" height="25" class="swfupload">
        <param name="wmode" value="window">
        <param name="movie" value="${ctx}/resources/swfupload/swfupload/swfupload.swf?preventswfcaching=1370826936903">
        <param name="quality" value="high">
        <param name="allowScriptAccess" value="always">
        <param name="flashvars" value="movieName=SWFUpload_4&amp;uploadURL=%2F${ctx}%2Fjfile%2FprocessUpload&amp;useQueryString=false&amp;requeueOnError=false&amp;httpSuccess=&amp;assumeSuccessTimeout=0&amp;params=fileId%3D%26amp%3BbeanId%3Dnull%26amp%3BuploadPathKey%3D%26amp%3BuseSecurity%3D%26amp%3BuploadMode%3Ddb&amp;filePostName=Filedata&amp;fileTypes=*.*&amp;fileTypesDescription=All%20Files&amp;fileSizeLimit=100%20MB&amp;fileUploadLimit=30&amp;fileQueueLimit=0&amp;debugEnabled=false&amp;buttonImageURL=${ctx}%2Fresources%2Fswfupload%2Fimages%2Fbtn_file_search2.png&amp;buttonWidth=92&amp;buttonHeight=25&amp;buttonText=&amp;buttonTextTopPadding=0&amp;buttonTextLeftPadding=0&amp;buttonTextStyle=color%3A%20%23000000%3B%20font-size%3A%2016pt%3B&amp;buttonAction=-110&amp;buttonDisabled=false&amp;buttonCursor=-2">
        </object>
        </div>

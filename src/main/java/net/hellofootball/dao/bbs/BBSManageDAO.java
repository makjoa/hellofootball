package net.hellofootball.dao.bbs;
...
public class BBSManageDAO extends EgovAbstractMapper {
	...
	public void insertBoardArticle(Board board) throws Exception {
		//long nttId = (Long)selectByPk("BBSManageDAO.selectMaxNttId");//2011.09.22
	...
	public long replyBoardArticle(Board board) throws Exception {
		long nttId = (Long)selectByPk("BBSManageDAO.selectMaxNttId", board);
		...
		long nttNo = (Long)selectByPk("BBSManageDAO.getParentNttNo", board);
	...
	public int selectBoardArticleListCnt(BoardVO boardVO) throws Exception {
		return (Integer)selectByPk("BBSManageDAO.selectBoardArticleListCnt", boardVO);
	}
	...
	public int selectMaxInqireCo(BoardVO boardVO) throws Exception {
		return (Integer)selectByPk("BBSManageDAO.selectMaxInqireCo", boardVO);
	}
	...
	public long selectNoticeItemForSort(Board board) throws Exception {
		return (Long)selectByPk("BBSManageDAO.selectNoticeItemForSort", board);
	}
	...
	public int selectGuestListCnt(BoardVO boardVO) throws Exception {
		return (Integer)selectByPk("BBSManageDAO.selectGuestListCnt", boardVO);
	}
	...
	public String getPasswordInf(Board board) throws Exception {
		return (String)selectByPk("BBSManageDAO.getPasswordInf", board);
	}
}

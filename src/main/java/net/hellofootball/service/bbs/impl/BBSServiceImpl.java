package net.hellofootball.service.bbs.impl;
...
import net.hellofootball.dao.bbs.BBSManageDAO;
...
import net.hellofootball.domain.bbs.Board;
import net.hellofootball.domain.bbs.BoardVO;
import net.hellofootball.service.bbs.EgovBBSManageService;
import net.hellofootball.util.EgovDateUtil;
...
public class BBSServiceImpl extends AbstractServiceImpl implements EgovBBSManageService {
	...
	private static final Logger LOG = Logger.getLogger(BBSServiceImpl.class.getClass());

	/**
	 * 게시물 한 건을 삭제 한다.
	 * 
	 * @see net.hellofootball.service.bbs.brd.service.EgovBBSManageService#deleteBoardArticle(net.hellofootball.domain.bbs.brd.service.Board)
	 */
	 ...
	 * 
	 * @see net.hellofootball.service.bbs.brd.service.EgovBBSManageService#insertBoardArticle(net.hellofootball.domain.bbs.brd.service.Board)
	 */
	 ...
	 * 
	 * @see net.hellofootball.service.bbs.brd.service.EgovBBSManageService#selectBoardArticle(net.hellofootball.domain.bbs.brd.service.BoardVO)
	 */
	 ...
	 * 
	 * @see net.hellofootball.service.bbs.brd.service.EgovBBSManageService#selectBoardArticles(net.hellofootball.domain.bbs.brd.service.BoardVO)
	 */
	 ...
	 * 게시물 한 건의 내용을 수정 한다.
	 * 
	 * @see net.hellofootball.service.bbs.brd.service.EgovBBSManageService#updateBoardArticle(net.hellofootball.domain.bbs.brd.service.Board)
	 */
	 ...
	 * 방명록 내용을 삭제 한다.
	 * 
	 * @see net.hellofootball.service.bbs.brd.service.EgovBBSManageService#deleteGuestList(net.hellofootball.domain.bbs.brd.service.BoardVO)
	 */
	 ...
	 * 방명록에 대한 목록을 조회 한다.
	 * 
	 * @see net.hellofootball.service.bbs.brd.service.EgovBBSManageService#selectGuestList(net.hellofootball.domain.bbs.brd.service.BoardVO)
	 */

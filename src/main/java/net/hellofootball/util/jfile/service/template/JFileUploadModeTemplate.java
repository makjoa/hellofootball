package net.hellofootball.util.jfile.service.template;
...
import net.hellofootball.util.jfile.service.FileUploadCompletedEventListener;
import net.hellofootball.util.jfile.service.JFile;
import net.hellofootball.util.jfile.service.JFileDetails;
import net.hellofootball.util.jfile.service.strategy.JFileUploadTypeFactory;
import net.hellofootball.util.jfile.utils.KeyHelper;

package net.hellofootball.util.jfile.web;
...
import net.hellofootball.util.jfile.service.impl.JFileVO;
import net.hellofootball.util.jfile.session.SessionUploadChecker;
import net.hellofootball.util.jfile.utils.DateUtils;
import net.hellofootball.util.jfile.view.JSonView;
import net.hellofootball.util.jfile.view.JfileDownloadView;
...
public class JFileController {
	...
	@RequestMapping("jfileuploadForm")
...
//			}
	 ...
	 * @return
	 */
	@RequestMapping("afterProcessUploadCompleted")
	 ...
	 * 
	 */
	@RequestMapping("jfiledownloadForm")
	 ...
	 * @return
	 */
	@RequestMapping("readDownloadFiles")
	 ...
	 * @return
	 */
	@RequestMapping("readDownloadFile")

...
jwork.fileDownload.prototype.initProperties = function() {
	this.fileList = {};
	this.htmlUrl = this.ctx+"/jfile/jfiledownloadForm"
	this.beanId = "";
	this.uploadPathKey = "";
	thiswnloadCompleted = function(){};
	this.totalSize = 0;
...
jwork.fileDownload.prototype.insertFileList = function(fileList) {
	...
	for(var i=0; i<fileList.length; i++) {
		...
		file.count = fileInfownloadCount;
...
jwork.fileDownload.prototype.changePreview = function(fileId, seq) {
	...
	jQuery(img).attr("src", this.ctx + "/jfile/preview?fileId=" + fileId + "&fileSeq=" + seq + "&beanId="+this.beanId + "&uploadPathKey="+this.uploadPathKey);
}

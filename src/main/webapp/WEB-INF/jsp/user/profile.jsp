                    ...
                    <div class="dashboard" style="width: 302px; float:left;">
                        ...
                        <div class="module">
                            <ul class="js-nav-links">
                                ...
                                <li class="active"><a class="list-link js-nav" href="/user/settings/profile" data-nav="profile">프로필 <i class="chev-right"></i></a></li>
                    ...
                    <div class="content-main" style="width: 681px;">
                        <div class="content-header">
                            <div class="header-inner">
                                <h2>프로필</h2>
                                <p class="subheader">
                                    나의 공개 프로필, 검색 결과 등에 나타나는 정보를 설정합니다.
                                </p>
                            </div>
                        </div>
                            ...
                            <form id="profile-form" class="form-horizontal" enctype="multipart/form-data" method="POST" action="https://twitter.com/settings/profile">
                                            ...
                                            <div class="uploader-tools">
                                                <div id="duckface-uploader" class="hidden" style="display: block;">
                                                    <div id="choose-photo" class="dropdown">
                                                        ...
                                                        <div class="webcam-detect swf-container" style="width: 0px; height: 0px; overflow: hidden;">
                                                            <object data="/flash/WebcamDetector.swf" type="application/x-shockwave-flash" id="flash_71713443" width="1" height="1"><param name="wmode" value="transparent"><param name="AllowScriptAccess" value="sameDomain"><param name="movie" value="/flash/WebcamDetector.swf"></object>
                                                        </div>
                                                        <img src="https://abs.twimg.com/a/1364948424/images/spinner_center_72.gif" class="preview-spinner" style="display: none">
                                                    </div>
                                                    <p>
                                                        이 사진은 트윗과 항상 함께 따라다니는 나만의 자기 표현이 됩니다.
                                                    </p>
                                                </div>
                                        ...
                                        <div class="uploader-image uploader-header clearfix">
                                            ...
                                            <div class="uploader-tools">
                                                <div id="choose-header" class="dropdown">
                                                    ...
                                                    <div class="webcam-detect swf-container" style="width: 0px; height: 0px; overflow: hidden;">
                                                        <object data="/flash/WebcamDetector.swf" type="application/x-shockwave-flash" id="flash_71787099" width="1" height="1"><param name="wmode" value="transparent"><param name="AllowScriptAccess" value="sameDomain"><param name="movie" value="/flash/WebcamDetector.swf"></object>
                                                    </div>
                                                    <img src="https://abs.twimg.com/a/1364948424/images/spinner_center_72.gif" class="preview-spinner" style="display: none">
                                                    <div class="photo-selector">
                                                        <button class="btn" type="button">
                                                ...
                                                <p class="profile-settings-help">
                                                    도움이 필요하세요? <a href="https://support.twitter.com/articles/127871" target="_blank" id="profile_image_help">더 알아보기</a>.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <fieldset class="control-group">
                                    ...
                                    <div id="user_description_box" class="controls">
                                        ...
                                        <p class="bio-label">
                                            <strong>160</strong>자 이내로 자신을 표현해보세요. <span class="user_description_count">160</span>
                                        </p>
                                    </div>
                                </fieldset>
                                <hr>
                                ...
                                <div class="controls">
                                    <iframe id="fb-iframe" scrolling="no" frameborder="0" src="/settings/facebook/frame" style="height: 68px;" data-facebook-frame-loaded="true">
                                    </iframe>
                                    <p>
                                        <a href="#" id="fb-anchor" class="btn" style="display: none;"><span>내 트윗을 Facebook에도 올리기</span></a>
                                    </p>
                                    <p>
                                        문제가 있나요? <a href="https://support.twitter.com/articles/31113" target="_blank">더 알아보기</a>
                                    </p>
                                </div>
                                <hr>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="alert profile-image-alert message" style="display: none;">
                                                <div>
                                                    <span id="profile-image-alert-message"></span><a class="dismiss" href="#">×</a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="upload-frame clearfix image-upload-spinner">
                                            </div>
                                        </div>
                                        <div class="modal-footer">

...
<script src="${pageContext.request.contextPath}/resources/editor/js/editor_loader.js?environment=development" type="text/javascript" charset="utf-8"></script>
                            ...
                            <div class="flex-module profile-summary js-profile-summary">
                                ...
                                <div class="content">
                                    <div class="account-group js-mini-current-user" data-user-id="129483340" data-screen-name="mouse208">
                                        <img class="avatar size32" src="https://si0.twimg.com/profile_${pageContext.request.contextPath}/resources/editor/images/1157074264/38_4_normal.jpg" alt="최중섭" data-user-id="129483340">
                    ...
                    <div class="content-main" style="width: 761px;">
                        ...
                        <div class="content-inner no-stream-end">
							...
							<form:form modelAttribute="Article" name="news" id="news" action="/bbs" method="${method}" accept-charset="utf-8">
								<div id="write_head">								    
								    <span>
								    <form:hidden path="num" />
								    <form:hidden path="mb_id" value="makjoa" />
								    <form:hidden path="name" value="makjoa" />
								    <select id="cat_name" name="cat_name" class="inp" onchange="changeBBS(this.value);">
								        ...
								        <option value="KNT">대표팀</option>
								        <option value="INF">해외축구</option>
								    </select>
								    </span>
								    <p class="head_set" id="spanHeadArea" style="display: inline;">
								        <select id="sort" name="sort" class="inp" style="display: none;">
							    ...
							    <div id="tx_trex_container" class="tx-editor-container">
							                ...
							                <ul class="tx-bar tx-bar-left">
							                    ...
							                    <div id="tx_richtextbox_menu" class="tx-richtextbox-menu tx-menu">
							                        ...
							                        <div class="tx-menu-footer">
							                            <img class="tx-menu-confirm" src="${pageContext.request.contextPath}/resources/editor/images/icon/editor/btn_confirm.gif?rv=1.0.1" alt=""/>
							                            <img class="tx-menu-cancel" hspace="3" src="${pageContext.request.contextPath}/resources/editor/images/icon/editor/btn_cancel.gif?rv=1.0.1" alt=""/>
							                        </div>
							                    </div>
							                    </li>
							                    <li class="tx-list">
							        ...
							        <div id="tx_canvas" class="tx-canvas">
							            <div id="tx_loading" class="tx-loading">
							                <div>
							                    <img src="${pageContext.request.contextPath}/resources/editor/images/icon/editor/loading2.png" width="113" height="21" align="absmiddle"/>
							                </div>
							            </div>
							            ...
							            <div id="tx_attach_box" class="tx-attach-box">
							                <div class="tx-attach-box-inner">
							                    <div id="tx_attach_preview" class="tx-attach-preview">
							                        ...
							                        <img src="${pageContext.request.contextPath}/resources/editor/images/icon/editor/pn_preview.gif" width="147" height="108" unselectable="on"/>
							                    </div>
							...
							<div  style="text-align: center;">
							    ...
							    <span><a class="btn primary-btn tweet-action" style="float: right; type="button" href="news/form">글쓰기</a></span>
							</div>							
<!-- 에디터 끝 -->
